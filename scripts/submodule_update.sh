...
git submodule add --force https://gitlab.sh.netgenwaterprediction/NGWPC/nwm-ngen/lgar-c.git extern/LASAM/
git submodule add --force https://gitlab.sh.netgenwaterprediction/NGWPC/nwm-ngen/snow17.git extern/snow17/
git submodule add --force https://gitlab.sh.netgenwaterprediction/NGWPC/nwm-ngen/sac-sma.git ./extern/sac-sma/sac-sma/
git submodule update --init --recursive
