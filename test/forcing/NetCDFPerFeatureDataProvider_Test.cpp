...
void NetCDFPerFeatureDataProviderTest::setupForcing() {
	...
	//Debugging - KSL
	log_file << "About to read files." <<std::endl;
	log_file.flush();
	//End Debug - KSL
	...
	//Debugging - KSL
    for (const std::string& file : forcing_file_names) {
        log_file << "forcing_file_names =" << file << std::endl;
        log_file.flush();
    }
	//End debugging - KSL 
    ...
    //Debugging - KSL
    log_file << "Debug: forcing_file_name = " << forcing_file_name << std::endl;
    log_file.flush();
    //End debugging - KSL
   
    // Using this to compute epoch times... this is what's done in Formulation_Constructors.hpp, FWIW...
    // Updated times for new sample file - KSL
    forcing_params forcing_p(forcing_file_name, "NetCDF", "2024-10-18 07:00:00", "2024-10-18 21:00:00");
    ...
    //Debugging - KSL
    log_file << "Debug: start_date_time = " << start_date_time << std::endl;
    log_file << "Debug: end_date_time = " << end_date_time << std::endl;
    log_file.flush();
    //End debugging - KSL
